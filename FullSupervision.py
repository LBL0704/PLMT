...
from Datasets.config import acdc_only_10_train_dataset, acdc_only_20_train_dataset
...
parser.add_argument("--exp", type=str, default="ACDC/FullSupervision", help="framework")
...
def train(args, snapshot_path):
    ...
    if args.labeled_num == "10":
        db_train = acdc_only_10_train_dataset
    elif args.labeled_num == "20":
        db_train = acdc_only_20_train_dataset
    else:
