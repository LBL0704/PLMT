...
parser.add_argument("--exp", type=str, default="ACDC/SelfTraining", help="framework")
parser.add_argument("--etd", type=str, default="ACDC/SelfTraining", help="framework")
...
def label(model, best_model_path, dataset_path):
    ...
    model.eval()
    train_dataset = acdc_unlabeled_dataset
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num < 200:
                ...
                unsupervised_loss = losses.confidence_ce_loss(outputs_soft[args.labeled_bs:],
...
def run():
    ...
    model_path = r"/home/baldwin/PLMT/Experiments/{}/FullSupervision_all_labeled/{}".format(
        args.etd, args.model
    )
